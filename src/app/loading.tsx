      ...
      <section className="bg-gradient-to-br from-background via-background to-primary/5">
        <div className="mx-auto max-w-7xl px-6 lg:px-12 xl:px-16 py-16 md:py-24">
          <div className="max-w-2xl space-y-4">
            <div className="h-6 w-48 bg-rari-elevated rounded animate-pulse" />
            <div className="h-12 w-96 bg-rari-elevated rounded animate-pulse" />
            <div className="h-5 w-80 bg-rari-elevated rounded animate-pulse" />
          </div>
        </div>
      </section>
      {/* Items skeleton */}
      <section className="mx-auto max-w-7xl px-6 lg:px-12 xl:px-16 py-8">
        <div className="h-8 w-32 bg-rari-elevated rounded animate-pulse mb-6" />
